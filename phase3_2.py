...
# Instantiate the simulation with Root() object before calling instantiate
...
dvfs.scale(voltage='0.9V', frequency='800MHz')  # Voltage should be passed as a string

# Collect statistics before and after the workload runs for more accurate measurement
m5.stats.reset()  # Reset statistics to get clean data
m5.simulate()  # Run the simulation

# Dump stats at the end of the simulation
m5.stats.dump()  # Save statistics to the output file

# If GDB is requested, wait for a connection
if args.wait_gdb:
