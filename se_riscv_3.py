...
for i in range(np):
    ...
    system.cpu[i].icache.mem_side = system.membus.cpu_side_ports
    system.cpu[i].dcache.mem_side = system.membus.cpu_side_ports

# Connect system port to the memory bus
system.system_port = system.membus.cpu_side_ports

# Detailed memory configuration
system.mem_ctrl = SimpleMemory(range=system.mem_ranges[0])  # Updated to use SimpleMemory
